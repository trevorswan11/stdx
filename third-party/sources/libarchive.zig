...
pub fn configHeader(
    ...
    const config = b.addConfigHeader(.{ .style = style }, .{
        ...
        .HAVE_UINTMAX_T = true,
        .@"const" = .@"const",
        .BSDCAT_VERSION_STRING = version_str,
        .BSDCPIO_VERSION_STRING = version_str,
        .BSDTAR_VERSION_STRING = version_str,
        .BSDUNZIP_VERSION_STRING = version_str,
        ...
        .LIBATTR_PKGCONFIG_VERSION = "0.0.0",
        .LIBACL_PKGCONFIG_VERSION = "0.0.0",
        .LIBRICHACL_PKGCONFIG_VERSION = "0.0.0",
        ...
        .LIBARCHIVE_VERSION_STRING = version_str,
        ...
        .PACKAGE_STRING = "libarchive-" ++ version_str,
...
pub const unix_sources = [_][]const u8{
    "filter_fork_posix.c",
